...
public class V32Disassm {
	...
	enum Ope {
		...
		SUBL3(0xc3, new MetaInfo(OT.l, OT.l, OT.l)), 
		...
		EXTZV(0xef, new MetaInfo(OT.l, OT.b, OT.b, OT.l)), 
		...
		MNEGD(0x72, new MetaInfo(OT.df, OT.df)),
		...
		BNEQ(0x12, new MetaInfo(OT.Brb)), BNQL(0x13, new MetaInfo(OT.Brb)), BGTR(0x14, new MetaInfo(OT.Brb)),
